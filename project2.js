function getAngle() {
    ...
    //adding traslateX here otherwise only rotates works
    hourHand.style.transform = `traslateX(-50%) rotate(${hrHandRotation}deg)`;
...
getAngle();
//to start the clock as soon as page loads otherwise it jumps to current time abruptly form 12
